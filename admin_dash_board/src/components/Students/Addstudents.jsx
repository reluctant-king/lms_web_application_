...
const AddStudents = () => {
  ...
  useEffect(() => {
    axios
      .get("https://lms-web-application-backend-ymjf.onrender.com/api/v1/view_all_batches")
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://lms-web-application-backend-ymjf.onrender.com/api/v1/add_student", {
        ...inputs,
