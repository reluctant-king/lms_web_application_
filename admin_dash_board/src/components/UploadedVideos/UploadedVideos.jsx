...
const UploadedVideos = () => {
  ...
  const getAllVideos = async (page = 1) => {
    try {
      const res = await axios.get('https://lms-web-application-backend-ymjf.onrender.com/api/v1/get_all_records');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
      ...
      {showEditPopop && <Edit
        ...
        api_end_point="https://lms-web-application-backend-ymjf.onrender.com/api/v1/get_recoeded_video"
        id={id}
